...
public class LinicOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
	...
	public OAuth2User loadUser(final OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
		...
		if (!StringUtils
			...
			// in the Anaf case we don't have a user, we just want the access token
...
//			throw new OAuth2AuthenticationException(oauth2Error, oauth2Error.toString());
			...
			final String userNameAttributeName = "id";
			final Map<String, Object> userAttributes = Map.of("id", userRequest.getClientRegistration().getClientId());
			final Set<GrantedAuthority> authorities = new LinkedHashSet<>();
			authorities.add(new OAuth2UserAuthority(userAttributes));
			return new DefaultOAuth2User(authorities, userAttributes, userNameAttributeName);
		}
		final String userNameAttributeName = userRequest.getClientRegistration().getProviderDetails().getUserInfoEndpoint()
	...
	private ResponseEntity<Map<String, Object>> getResponse(final OAuth2UserRequest userRequest, final RequestEntity<?> request) {
		try {
	 ...
	 * @since 5.1
	 */
	public final void setRequestEntityConverter(final Converter<OAuth2UserRequest, RequestEntity<?>> requestEntityConverter) {
	 ...
	 * @since 5.1
	 */
	public final void setRestOperations(final RestOperations restOperations) {
